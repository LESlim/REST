...
public class FooServiceUnitTest{
	...
	public final void before(){
		this.instance = new FooServiceImpl();
		
		this.daoMock = mock( IFooJpaDAO.class );
		when( this.daoMock.findAll() ).thenReturn( Lists.<Foo> newArrayList() );
